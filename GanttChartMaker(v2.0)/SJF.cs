...
{
    class SJF : Algorithm, IPreemptive
    {
        private readonly String name = "Shortest Job First";
        ...
        {
            return "This algorithm takes the shortest job available and executes it first.";
        }
    }
}